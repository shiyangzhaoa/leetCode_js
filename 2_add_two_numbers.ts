...
const addTwoNumbers1 = (l1: [number], l2: [number]) => {
...
const addTwoNumbers2 = (l1: ListNode, l2: ListNode) => {
  let resultList = null;
  let curNode = null;
  let curCarry = 0;
  let v1 = 0;
  ...
  const getValAndMoveToNext = (list1: any, list2: any) => {
